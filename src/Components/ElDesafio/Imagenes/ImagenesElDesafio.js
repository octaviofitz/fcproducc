...
function ImagenesElDesafio() {
    ...
    return (
        <article className='imgElDesafio'>
            ...
            <Button variant="success" size='lg' className='botonm42'><Link to='https://drive.google.com/drive/folders/1b958l1MQaTtYXiAq6NyEulTbIWRCwNJT' target="_blank" rel="noopener noreferrer">Fotos</Link></Button>
        </article>
    );
}
